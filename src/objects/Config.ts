...
class Config {
    static models: string = 'ollamaModels';
    static systemPrompt: string = 'systemPrompt';
    static url: string = 'ollamaUrl';
    static defaultModels: { name: string, value: string }[] = [{ "name": "Qwen2.5-Coder:3b", "value": "qwen2.5-coder:3b" }];
    static defaultUrl: string = 'http://127.0.0.1:11434';
